            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    if (firebaseAuth.getCurrentUser().isEmailVerified()){
                        if (firebaseAuth.getCurrentUser().getEmail().equals("hdanhv5879@gmail.com"))
                    ...
                    Toast.makeText(LoginActivity.this, "Something went wronga!", Toast.LENGTH_SHORT).show();
                }
                Log.d("WEB_CLIENT_ID", getString(R.string.default_web_client_id));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 101){
            ...
            try {
                ...
                Toast.makeText(this, "Something went wrong123!", Toast.LENGTH_SHORT).show();
            }
        }
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (email.equals("hdanhv5879@gmail.com"))  // Admin
